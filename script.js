...
const TRANSLATIONS = {
  en: {
    ...
    'os-banner-title': 'Open Source — Free Solutions to Real Problems',
    'os-banner-desc': 'Tools released free for everyone — solving issues that usually require paid software or complex setup.',
    'kofi-hackersim': '☕ Support hackersim development on Ko-fi',
    'kofi-1a2h': '☕ Buy me a coffee — keep tools like this free',
    'kofi-fsd': '☕ Donate on Ko-fi — fight predatory PC cleaner industry',
    'th-tagline': 'One audio source, two headphones — share sound instantly without hardware splitters or complex setup.',
    'th-desc': 'Solves a problem that\'s surprisingly hard otherwise — synchronized audio playback across two pairs of headphones from one device. No hardware splitters (which cause volume drops), no Bluetooth pairing dances, no driver hacks. Just open in browser, plug both headphones, share the sound. Released free as alternative to paid audio routing software costing $30-100.',
    'fsd-tagline': 'Free Windows diagnostics — replaces $30-50/year "PC optimizers" with honest open-source tooling.',
    'fsd-desc': 'Full Windows diagnostic and repair toolkit — built specifically as alternative to predatory "PC cleaner" software (CCleaner Pro, IObit, Restoro) that charge subscriptions for things Windows already does free. No subscriptions, no upsells, no false alarms inflating "issues count" to scare users into paying. Honest open-source code anyone can audit.',
  ...
  pl: {
    ...
    'os-banner-title': 'Open Source — Darmowe rozwiązania prawdziwych problemów',
    'os-banner-desc': 'Narzędzia udostępnione za darmo dla wszystkich — rozwiązują problemy zwykle wymagające płatnego oprogramowania lub skomplikowanej konfiguracji.',
    'kofi-hackersim': '☕ Wesprzyj rozwój hackersim na Ko-fi',
    'kofi-1a2h': '☕ Postaw mi kawę — pomóż utrzymać darmowe narzędzia',
    'kofi-fsd': '☕ Wspomóż na Ko-fi — walcz z drapieżnymi PC cleanerami',
    'th-tagline': 'Jedno źródło audio, dwie pary słuchawek — dziel się dźwiękiem natychmiast bez splitterów ani skomplikowanej konfiguracji.',
    'th-desc': 'Rozwiązuje zaskakująco trudny problem — zsynchronizowane odtwarzanie audio na dwóch parach słuchawek z jednego urządzenia. Bez splitterów sprzętowych (które zmniejszają głośność), bez tańca z parowaniem Bluetooth, bez hakowania sterowników. Po prostu otwórz w przeglądarce, podłącz obie słuchawki, dziel dźwięk. Udostępnione za darmo jako alternatywa dla płatnych programów do routowania audio kosztujących $30-100.',
    'fsd-tagline': 'Darmowa diagnostyka Windows — zastępuje "PC optymalizery" za $30-50/rok uczciwym narzędziem open-source.',
    'fsd-desc': 'Pełny zestaw narzędzi diagnostycznych i naprawczych Windows — zbudowany konkretnie jako alternatywa dla drapieżnych "PC cleanerów" (CCleaner Pro, IObit, Restoro) pobierających subskrypcje za rzeczy które Windows już robi za darmo. Bez subskrypcji, bez upselli, bez fałszywych alarmów napompowujących "liczbę problemów" by przestraszyć użytkowników do płacenia. Uczciwy kod open-source, każdy może sprawdzić.',
...
function showLanguageTooltip() {
  const langBtn = document.getElementById('lang-toggle-btn');
  if (langBtn && !localStorage.getItem('tooltipShown')) {
    const tooltip = document.createElement('div');
    tooltip.className = 'lang-tooltip';
    tooltip.textContent = '🌐 Click to change language / Kliknij aby zmienić język';
